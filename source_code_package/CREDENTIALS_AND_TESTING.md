...
| Environment | URL |
|-------------|-----|
| **Preview App** | https://dammaiguda.preview.emergentagent.com |
| **Production** | https://www.mydammaiguda.in |
| **API Docs** | https://dammaiguda.preview.emergentagent.com/docs |
...
**URL:** https://dammaiguda.preview.emergentagent.com/portals
...
**URL:** https://dammaiguda.preview.emergentagent.com/auth
...
```bash
curl https://dammaiguda.preview.emergentagent.com/api/education/courses
```
...
curl -H "Authorization: Bearer $TOKEN" \
  https://dammaiguda.preview.emergentagent.com/api/auth/me
```
