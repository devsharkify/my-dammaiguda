...
export default function IssueFeed() {
  ...
  const statusColors = {
    ...
    filed_with_authority: "bg-indigo-100 text-indigo-700 border-indigo-200",
    resolved_by_authority: "bg-green-100 text-green-700 border-green-200",
    resolved_by_us: "bg-emerald-100 text-emerald-700 border-emerald-200",
    issue_not_found: "bg-gray-100 text-gray-700 border-gray-200",
    escalated: "bg-red-100 text-red-700 border-red-200",
    closed: "bg-green-100 text-green-700 border-green-200"
  };

  const statusIcons = {
    reported: <Clock3 className="h-3 w-3" />,
    verified: <CheckCircle className="h-3 w-3" />,
    action_taken: <Send className="h-3 w-3" />,
    filed_with_authority: <FileText className="h-3 w-3" />,
    resolved_by_authority: <CheckCircle className="h-3 w-3" />,
    resolved_by_us: <CheckCircle className="h-3 w-3" />,
    issue_not_found: <XCircle className="h-3 w-3" />,
