...
| Environment | URL |
|-------------|-----|
| **Preview App** | https://engagement-hub-63.preview.emergentagent.com |
| **Production** | https://www.mydammaiguda.in |
| **API Docs** | https://engagement-hub-63.preview.emergentagent.com/docs |
...
**URL:** https://engagement-hub-63.preview.emergentagent.com/portals
...
**URL:** https://engagement-hub-63.preview.emergentagent.com/auth
...
### 1. Health Check
```bash
curl https://engagement-hub-63.preview.emergentagent.com/api/health
```

### 2. Send OTP
```bash
curl -X POST "https://engagement-hub-63.preview.emergentagent.com/api/auth/otp" \
...
```bash
curl -X POST "https://engagement-hub-63.preview.emergentagent.com/api/auth/verify" \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST "https://engagement-hub-63.preview.emergentagent.com/api/auth/admin-login" \
  -H "Content-Type: application/json" \
...
```bash
curl https://engagement-hub-63.preview.emergentagent.com/api/education/courses
```
...
curl -H "Authorization: Bearer $TOKEN" \
  https://engagement-hub-63.preview.emergentagent.com/api/auth/me
```
...
```
REACT_APP_BACKEND_URL=https://engagement-hub-63.preview.emergentagent.com
```
