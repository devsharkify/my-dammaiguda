...
- [x] ✅ **Remove Test OTP Backdoor** - CRITICAL security fix (COMPLETED - Feb 23, 2026)
- [x] ✅ **Fix News Page Mock Data** - Now shows only admin-pushed news (COMPLETED - Feb 23, 2026)
